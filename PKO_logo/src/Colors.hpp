...
Vec3b const RED = Vec3b(255,0,0);
Vec3b const LIME = Vec3b(0,255,0);
Vec3b const BLUE = Vec3b(0,0,255);
Vec3b const YELLOW = Vec3b(255,255,0);
Vec3b const CYAN = Vec3b(0,255,255);
Vec3b const MAGENTA = Vec3b(255,0,255);
Vec3b const SILVER = Vec3b(192,192,192);
Vec3b const GRAY = Vec3b(128,128,128);
Vec3b const MAROON = Vec3b(128,0,0);
Vec3b const OLIVE = Vec3b(128,128,0);
Vec3b const GREEN = Vec3b(0,128,0);
Vec3b const PURPLE = Vec3b(128,0,128);
Vec3b const TEAL = Vec3b(0,128,128);
Vec3b const NAVY = Vec3b(0,0,128);
